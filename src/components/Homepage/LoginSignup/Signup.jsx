...
// import { useUserAuth } from "../../../Context/PhoneAuth";
...
export const Singup = () => {
  ...
  //   const { setUpRecaptch } = useUserAuth();

  const dispatch = useDispatch();
  const handleSignIn = () => {
    dispatch(googleSignin());
    // axios
    //   .get("https://airbnbclonee.herokuapp.com/auth/google")
    //   .then((data) => console.log(data))
    //   .then(
    //     () =>
    //       (window.location.href =
    //         "https://airbnbclonee.herokuapp.com/auth/google")
    //   );
  };
      ...
      <div className={Styles.a_signupContainer}>
        ...
        <div className={Styles.a_welcome_container}>
          <div className={Styles.a_welcome_inside_container}>
            ...
            <div
              style={{ display: "flex" }}
              className={Styles.a_signup_options}
            >
              <img
